...
extension ApiSchema {
	...
	open class LineItemConnection: GraphQL.AbstractResponse
	{
		...
		open var edges: [ApiSchema.LineItemEdge] {
			return internalGetEdges()
		}

		func internalGetEdges(aliasSuffix: String? = nil) -> [ApiSchema.LineItemEdge] {
			return field(field: "edges", aliasSuffix: aliasSuffix) as! [ApiSchema.LineItemEdge]
		}
