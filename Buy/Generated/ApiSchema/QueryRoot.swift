...
extension ApiSchema {
	...
	open class QueryRoot: GraphQL.AbstractResponse
	{
		...
		open var shop: ApiSchema.Shop {
			return internalGetShop()
		}

		func internalGetShop(aliasSuffix: String? = nil) -> ApiSchema.Shop {
			return field(field: "shop", aliasSuffix: aliasSuffix) as! ApiSchema.Shop
		}
