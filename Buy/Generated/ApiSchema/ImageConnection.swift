...
extension ApiSchema {
	open class ImageConnectionQuery: GraphQL.AbstractQuery {
		...
		@discardableResult
		open func pageInfo(aliasSuffix: String? = nil, _ subfields: (PageInfoQuery) -> Void) -> ImageConnectionQuery {
	...
	open class ImageConnection: GraphQL.AbstractResponse
	{
		...
		open var typeName: String { return "ImageConnection" }

		open var edges: [ApiSchema.ImageEdge] {
			return internalGetEdges()
		}

		func internalGetEdges(aliasSuffix: String? = nil) -> [ApiSchema.ImageEdge] {
			return field(field: "edges", aliasSuffix: aliasSuffix) as! [ApiSchema.ImageEdge]
		}
