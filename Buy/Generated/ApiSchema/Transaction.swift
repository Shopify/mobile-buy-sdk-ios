...
extension ApiSchema {
	...
	open class Transaction: GraphQL.AbstractResponse
	{
		...
		open var kind: ApiSchema.TransactionKind {
			return internalGetKind()
		}

		func internalGetKind(aliasSuffix: String? = nil) -> ApiSchema.TransactionKind {
			return field(field: "kind", aliasSuffix: aliasSuffix) as! ApiSchema.TransactionKind
		}

		open var status: ApiSchema.TransactionStatus {
			return internalGetStatus()
		}

		func internalGetStatus(aliasSuffix: String? = nil) -> ApiSchema.TransactionStatus {
			return field(field: "status", aliasSuffix: aliasSuffix) as! ApiSchema.TransactionStatus
		}
