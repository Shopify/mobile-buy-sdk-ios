...
extension ApiSchema {
	...
	open class ProductEdge: GraphQL.AbstractResponse
	{
		...
		open var node: ApiSchema.Product {
			return internalGetNode()
		}

		func internalGetNode(aliasSuffix: String? = nil) -> ApiSchema.Product {
			return field(field: "node", aliasSuffix: aliasSuffix) as! ApiSchema.Product
		}
