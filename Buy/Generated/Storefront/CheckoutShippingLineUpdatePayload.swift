...
extension Storefront {
	open class CheckoutShippingLineUpdatePayloadQuery: GraphQL.AbstractQuery {
		...
		@discardableResult
		open func clientMutationId(aliasSuffix: String? = nil) -> CheckoutShippingLineUpdatePayloadQuery {
			addField(field: "clientMutationId", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func userErrors(aliasSuffix: String? = nil, _ subfields: (UserErrorQuery) -> Void) -> CheckoutShippingLineUpdatePayloadQuery {
	...
	open class CheckoutShippingLineUpdatePayload: GraphQL.AbstractResponse
	{
		...
		open var typeName: String { return "CheckoutShippingLineUpdatePayload" }
