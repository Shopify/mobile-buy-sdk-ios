...
extension Storefront {
	open class CheckoutLineItemsUpdatePayloadQuery: GraphQL.AbstractQuery, GraphQLQuery {
		...
		@discardableResult
		open func userErrors(aliasSuffix: String? = nil, _ subfields: (UserErrorQuery) -> Void) -> CheckoutLineItemsUpdatePayloadQuery {
	...
	open class CheckoutLineItemsUpdatePayload: GraphQL.AbstractResponse, GraphQLObject {
		...
		open var typeName: String { return "CheckoutLineItemsUpdatePayload" }
