...
extension Storefront {
	open class CheckoutLineItemEdgeQuery: GraphQL.AbstractQuery {
		...
		@discardableResult
		open func node(aliasSuffix: String? = nil, _ subfields: (CheckoutLineItemQuery) -> Void) -> CheckoutLineItemEdgeQuery {
	...
	open class CheckoutLineItemEdge: GraphQL.AbstractResponse
	{
		...
		open var typeName: String { return "CheckoutLineItemEdge" }
		...
		func internalGetNode(aliasSuffix: String? = nil) -> Storefront.CheckoutLineItem {
			return field(field: "node", aliasSuffix: aliasSuffix) as! Storefront.CheckoutLineItem
		}
