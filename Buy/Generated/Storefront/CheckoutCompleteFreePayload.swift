...
extension Storefront {
	open class CheckoutCompleteFreePayloadQuery: GraphQL.AbstractQuery {
		...
		@discardableResult
		open func clientMutationId(aliasSuffix: String? = nil) -> CheckoutCompleteFreePayloadQuery {
			addField(field: "clientMutationId", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func userErrors(aliasSuffix: String? = nil, _ subfields: (UserErrorQuery) -> Void) -> CheckoutCompleteFreePayloadQuery {
	...
	open class CheckoutCompleteFreePayload: GraphQL.AbstractResponse
	{
		...
		open var typeName: String { return "CheckoutCompleteFreePayload" }
