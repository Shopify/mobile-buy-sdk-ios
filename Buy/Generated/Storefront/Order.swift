...
extension Storefront {
	...
	open class Order: GraphQL.AbstractResponse, Node
	{
		...
		func internalGetCancelReason(aliasSuffix: String? = nil) -> Storefront.OrderCancelReason? {
			return field(field: "cancelReason", aliasSuffix: aliasSuffix) as! Storefront.OrderCancelReason?
		}
		...
		func internalGetDisplayFinancialStatus(aliasSuffix: String? = nil) -> Storefront.OrderDisplayFinancialStatus? {
			return field(field: "displayFinancialStatus", aliasSuffix: aliasSuffix) as! Storefront.OrderDisplayFinancialStatus?
		}
		...
		func internalGetDisplayFulfillmentStatus(aliasSuffix: String? = nil) -> Storefront.OrderDisplayFulfillmentStatus {
