...
extension Storefront {
	...
	open class PurchaseSession: GraphQL.AbstractResponse, Node
	{
		...
		open var items: Storefront.LineItemConnection {
			return internalGetItems()
		}

		open func aliasedItems(aliasSuffix: String) -> Storefront.LineItemConnection {
			return internalGetItems(aliasSuffix: aliasSuffix)
		}

		func internalGetItems(aliasSuffix: String? = nil) -> Storefront.LineItemConnection {
			return field(field: "items", aliasSuffix: aliasSuffix) as! Storefront.LineItemConnection
		}
