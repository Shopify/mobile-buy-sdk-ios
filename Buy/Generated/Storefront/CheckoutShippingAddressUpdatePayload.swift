...
extension Storefront {
	open class CheckoutShippingAddressUpdatePayloadQuery: GraphQL.AbstractQuery {
		...
		@discardableResult
		open func clientMutationId(aliasSuffix: String? = nil) -> CheckoutShippingAddressUpdatePayloadQuery {
			addField(field: "clientMutationId", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func userErrors(aliasSuffix: String? = nil, _ subfields: (UserErrorQuery) -> Void) -> CheckoutShippingAddressUpdatePayloadQuery {
	...
	open class CheckoutShippingAddressUpdatePayload: GraphQL.AbstractResponse
	{
		...
		open var typeName: String { return "CheckoutShippingAddressUpdatePayload" }
