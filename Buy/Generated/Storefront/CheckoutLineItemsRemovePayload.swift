...
extension Storefront {
	open class CheckoutLineItemsRemovePayloadQuery: GraphQL.AbstractQuery {
		...
		@discardableResult
		open func clientMutationId(aliasSuffix: String? = nil) -> CheckoutLineItemsRemovePayloadQuery {
			addField(field: "clientMutationId", aliasSuffix: aliasSuffix)
			return self
		}

		@discardableResult
		open func userErrors(aliasSuffix: String? = nil, _ subfields: (UserErrorQuery) -> Void) -> CheckoutLineItemsRemovePayloadQuery {
	...
	open class CheckoutLineItemsRemovePayload: GraphQL.AbstractResponse
	{
		...
		open var typeName: String { return "CheckoutLineItemsRemovePayload" }
