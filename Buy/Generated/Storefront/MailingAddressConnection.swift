...
extension Storefront {
	...
	open class MailingAddressConnection: GraphQL.AbstractResponse
	{
		...
		func internalGetEdges(aliasSuffix: String? = nil) -> [Storefront.MailingAddressEdge] {
			return field(field: "edges", aliasSuffix: aliasSuffix) as! [Storefront.MailingAddressEdge]
		}
