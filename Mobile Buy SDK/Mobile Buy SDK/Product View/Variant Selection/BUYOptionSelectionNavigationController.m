...
- (void)setTheme:(BUYTheme *)theme
{
	switch (theme.style) {
		...
		case BUYThemeStyleLight:
			[self.navigationBar setTitleTextAttributes:@{ NSForegroundColorAttributeName: [UIColor colorWithWhite:152.0/255.0f alpha:1.0] }];
			self.navigationBar.tintColor = [UIColor colorWithWhite:242.0/255.0f alpha:1.0];
			break;
	}
}
