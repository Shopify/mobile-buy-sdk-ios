...
extension ApiSchema {
	open class OrderConnectionQuery: GraphQL.AbstractQuery {
		...
		@discardableResult
		open func pageInfo(aliasSuffix: String? = nil, _ subfields: (PageInfoQuery) -> Void) -> OrderConnectionQuery {
	...
	open class OrderConnection: GraphQL.AbstractResponse
	{
		...
		open var typeName: String { return "OrderConnection" }

		open var edges: [ApiSchema.OrderEdge] {
			return internalGetEdges()
		}

		func internalGetEdges(aliasSuffix: String? = nil) -> [ApiSchema.OrderEdge] {
			return field(field: "edges", aliasSuffix: aliasSuffix) as! [ApiSchema.OrderEdge]
		}
