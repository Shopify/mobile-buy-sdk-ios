...
extension ApiSchema {
	...
	open class LineItemEdge: GraphQL.AbstractResponse
	{
		...
		open var node: ApiSchema.LineItem {
			return internalGetNode()
		}

		func internalGetNode(aliasSuffix: String? = nil) -> ApiSchema.LineItem {
			return field(field: "node", aliasSuffix: aliasSuffix) as! ApiSchema.LineItem
		}
