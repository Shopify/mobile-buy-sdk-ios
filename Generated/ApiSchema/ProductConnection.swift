...
extension ApiSchema {
	open class ProductConnectionQuery: GraphQL.AbstractQuery {
		...
		@discardableResult
		open func pageInfo(aliasSuffix: String? = nil, _ subfields: (PageInfoQuery) -> Void) -> ProductConnectionQuery {
	...
	open class ProductConnection: GraphQL.AbstractResponse
	{
		...
		open var typeName: String { return "ProductConnection" }

		open var edges: [ApiSchema.ProductEdge] {
			return internalGetEdges()
		}

		func internalGetEdges(aliasSuffix: String? = nil) -> [ApiSchema.ProductEdge] {
			return field(field: "edges", aliasSuffix: aliasSuffix) as! [ApiSchema.ProductEdge]
		}
