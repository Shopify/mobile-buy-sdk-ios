...
extension ApiSchema {
	...
	open class Product: GraphQL.AbstractResponse, Node
	{
		...
		open var images: ApiSchema.ImageConnection {
			return internalGetImages()
		}

		open func aliasedImages(aliasSuffix: String) -> ApiSchema.ImageConnection {
			return internalGetImages(aliasSuffix: aliasSuffix)
		}

		func internalGetImages(aliasSuffix: String? = nil) -> ApiSchema.ImageConnection {
			return field(field: "images", aliasSuffix: aliasSuffix) as! ApiSchema.ImageConnection
		}

		open var options: [ApiSchema.ProductOption] {
			return internalGetOptions()
		}

		open func aliasedOptions(aliasSuffix: String) -> [ApiSchema.ProductOption] {
			return internalGetOptions(aliasSuffix: aliasSuffix)
		}

		func internalGetOptions(aliasSuffix: String? = nil) -> [ApiSchema.ProductOption] {
			return field(field: "options", aliasSuffix: aliasSuffix) as! [ApiSchema.ProductOption]
		}
		...
		open var variants: ApiSchema.ProductVariantConnection {
			return internalGetVariants()
		}

		open func aliasedVariants(aliasSuffix: String) -> ApiSchema.ProductVariantConnection {
			return internalGetVariants(aliasSuffix: aliasSuffix)
		}

		func internalGetVariants(aliasSuffix: String? = nil) -> ApiSchema.ProductVariantConnection {
			return field(field: "variants", aliasSuffix: aliasSuffix) as! ApiSchema.ProductVariantConnection
		}
